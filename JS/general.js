...
=======
        ...
        document.getElementById("unomenos").addEventListener("click", () => {
            contador--
            document.querySelector(".contador").textContent = contador
>>>>>>> 41fa786caac12e53dd640cfca11ccdb68e5ca51a
        })
    } catch (error) {
        console.log(error);
    }
